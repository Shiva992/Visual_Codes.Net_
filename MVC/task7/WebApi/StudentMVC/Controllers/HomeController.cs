    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            using (WebClient webClient = new WebClient())
            {
                ...
                var list = JsonConvert.DeserializeObject<List<UserProject>>(res);
                return View(list);
            }
        ...
        [HttpPost]
        public ActionResult InsertData(UserProject std)
        {
            try
            {
                using (WebClient webClient = new WebClient())
        ...
        public ActionResult Details(int id)
        {
            using (WebClient webClient = new WebClient())
            {
                ...
                var list = JsonConvert.DeserializeObject<UserProject>(res);
                return View(list);
        ...
        public ActionResult UpdateData(int id)
        {
            using (WebClient webClient = new WebClient())
            {
                ...
                webClient.Headers.Add("Accept:application/Json");
                string res = webClient.DownloadString("https://localhost:44374/SelectData/" + id.ToString());
                return View(JsonConvert.DeserializeObject<UserProject>(res));
            }
        ...
        [HttpPost]
        public ActionResult UpdateData(UserProject std)
        { 
                using (WebClient webClient = new WebClient())
                {
                    webClient.Headers.Add("Content-type:application/Json");
