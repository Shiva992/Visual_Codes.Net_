...
using PartialViewDemo.Controllers;
...
namespace PartialViewDemo.Controllers
{
    public class ProductController : Controller
    {
        ...
        public PartialViewResult GetProducts()
        {
            ...
            Product product = new Product { ProductID = 1, Name = "Product 1", Category = "Category 1", Description = "Description 1", Price = 10m };
                
            
            return PartialView("OneView",product);
        }
    }
}